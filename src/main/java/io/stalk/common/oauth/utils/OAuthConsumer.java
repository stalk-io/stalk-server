...
import io.stalk.common.oauth.exception.SignatureException;
...
public class OAuthConsumer implements Serializable, Constants {
    ...
    /**
     * @param config Configuration object which contains information of application
     *               configuration
     */
     ...
     *
     * @param signatureType Type of signature. It can be HMAC-SHA1.
     * @param method        Method type can be GET, POST or PUT
     * @param url           Requested URL for which generating signature
     * @param args          Required arguments to generate signature
     ...
     *
     * @param reqTokenURL Request Token URL
     ...
     * @param token        Token to pass in GET request
     ...
     *
     * @param reqURL       URL to send request to.
     * @param params       Any additional parameters whose signature we want to compute.
     * @param headerParams Header Parameters
     * @param body         Request Body
     * @param token        Token to pass in POST request
     * @return Response object
     * @throws Exception
     */
     ...
     * @param headerParams Header Parameters
     * @param body         Request Body
     * @param token        Token to pass in PUT request
     * @return Response object
     * @throws Exception
     */
     ...
     * @param body             Request Body
     * @param token            Token to pass in PUT request
     * @param isHeaderRequired True if header is required
     * @return Response object
     * @throws Exception
     */
    public Response httpPut(final String reqURL,
     ...
     *
     * @param params Parameters to generate header value
